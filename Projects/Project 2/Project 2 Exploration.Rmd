...
model.fin <-
  glm(V4399 ~ 
    V3013 + V3015 + V3042 + V3044 + V3048 + 
    V3054 + V3077 + V3081 + PERINTVNUM + V4529 + V3042:V3081,
    data = crime.red3,
    family = "binomial"
...
model.gam <- gam(V4399 ~ s(V3013,3) + V3015 + V3042 + V3044 + V3048 + 
    V3054 + V3077 + V3081 + PERINTVNUM + V4529 + V3042:V3081, family = "binomial", data = crime.red2)
summary(model.gam)
