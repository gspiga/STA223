...
We could embed a new model with a quadtratic term or a another non-linear term. Doing this, we could compare the models via a likilihood ratio test and return the results to the investigator. 
